...
#Copyright Red Hat Software 2000
#Written by Brent Fox
...
#	buf = buf + "\n" + installTypeLookup(installTypeCombo.entry.get_text())
	...
	print buf
#	nis = myNisClass.return_data()
#	print nis
#	krb = myKerberosClass.return_data()
#	print krb
	
	ksFile = open("ks.cfg", "w")
	ksFile.write(buf)
	ksFile.close()
#	window.destroy()
#	mainquit()
...
#def enableNIS(args):
#	nisLabel1.set_sensitive(nisCheck.get_active())
#	nisDomainEntry.set_sensitive(nisCheck.get_active())
#	nisLabel2.set_sensitive(nisCheck.get_active())
#	nisBroadcastCheck.set_sensitive(nisCheck.get_active())	
#	nisServerEntry.set_sensitive(nisCheck.get_active())
...
okButton = GtkButton("Save File")
okButton.show()
okButton.connect("clicked", okClicked)
