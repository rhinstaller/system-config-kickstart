...
class ksconfig_gui:
	...
	def __init__ (self):
		...
		network_class = network.network(xml)
		#bring in auth functions
		auth_class = auth.auth(xml)
		#bring in install functions
		install_class = install.install(xml)
		#bring in firewall functions
		firewall_class = firewall.firewall(xml)
	...
	def select_clist(args):
		print "selected item"

	def unselect_clist(args):
