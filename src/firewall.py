...
#        self.customFrame.set_sensitive (active)
    ...
    def __init__(self, xml):
        ...
        xml.signal_autoconnect (
            { "disable_firewall" : xml.get_widget("disable_firewall"),
              })

        #create table with custom checklists
        label = GtkLabel ("Trusted devices:")
        label.set_alignment (0.2, 0.0)
        self.customTable.attach (label, 0, 1, 2, 3, FILL, FILL, 5, 5)
        ...
        self.customTable.attach (label, 0, 1, 3, 4, FILL, FILL, 5, 5)
...
#        label1.set_sensitive

        self.customTable.attach (label, 0, 1, 4, 5, FILL, FILL, 5, 5)
