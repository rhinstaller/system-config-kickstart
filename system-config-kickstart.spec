...
%changelog
* Wed Feb 25 2015 Chris Lumens <clumens@redhat.com> 2.8.6.6-1
- Remove the outdated documentation.
  Resolves: rhbz#1022372

* Mon Oct 15 2012 Chris Lumens <clumens@redhat.com> - 2.8.6.5-1
- Update Assamese translation.
  Resolves: rhbz#819813

* Fri Aug 05 2011 Chris Lumens <clumens@redhat.com> 2.8.6.4-1
- Don't traceback when starting up outside of X.
  Resolves: rhbz#676338

* Thu Jan 06 2011 Chris Lumens <clumens@redhat.com> 2.8.6.3-1
- Clear out the partitioning store when opening a new file.
  Resolves: rhbz#610740
- Default to SHA512 for passwords.
  Resolves: rhbz#633202
